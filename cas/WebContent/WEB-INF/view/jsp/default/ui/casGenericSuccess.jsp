...
<%
	/* MutableAttributeMap mutableAttributeMap = RequestContextHolder.getRequestContext().getRequestScope();
    		
    		Map map = mutableAttributeMap.asMap();
 ...
 */
	response.sendRedirect("http://192.168.3.189:8090/trans/exeLogin.html");
